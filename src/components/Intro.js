...
const Intro = () => {
  return (
    <div className="flex justify-center gap-10 ">
      ...
      <div className="w-[800px] rounded-lg text-center font-bold font-PT" id="shadow-2">
        ...
        >
            ...
            <ul className="flex justify-center gap-6 text-lg text-Orange items-center ">
              <li><i class="fa-solid fa-user-group text-Orange mr-1"></i>Followers</li>
              <li><i class="fa-solid fa-code-fork text-Orange mr-1"></i>Forks</li>
              <li><i class="fa-regular fa-star text-Orange mr-1"> </i>Stars</li>
            </ul>
          </div>
        </div>
      </div>
